module.exports = {
  ...
  plugins: [
    ...
    [
      ...
      {
        assets: ['package.json', 'README.md', 'docs/CHANGELOG.MD', 'dist/index.js', 'dist/index.min.js', 'dist/setup/gcalsync_dev.js', 'dist/setup/permissions.json', 'dist/setup/setup.js'],
